...
public class ChromeBrowser2 {
	...
	static void modify()
	{
		try
		{
			...
			oBrowser.findElement(By.name("lastName")).sendKeys("ks");
			Thread.sleep(2000);
			...
			oBrowser.findElement(By.name("username")).sendKeys("janu");
			Thread.sleep(2000);
			oBrowser.findElement(By.name("password")).clear();
			oBrowser.findElement(By.name("password")).sendKeys("manjula");
			Thread.sleep(2000);
			oBrowser.findElement(By.name("passwordCopy")).sendKeys("manjula");
			oBrowser.findElement(By.xpath(" //*[@id='userDataLightBox_commitBtn']/div/span")).click();
			Thread.sleep(4000);
		}
		catch(Exception e)
